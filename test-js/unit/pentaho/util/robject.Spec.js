...
define(function() {
  ...
  describe("squire pentaho.util.object - ", function() {
    ...
    it("should return the input object, if the desired prototype is an object", function(done){
      var localRequire = require.newContext();
  ...
  describe("squire-mocking pentaho.util.object", function() {
    ...
    [{
      ...
      it("should return the input object, if the desired prototype is an object - " + conf._label, function(done) {

        // Mocks
        define("pentaho/shim/env", conf);

        // Create local context, that captures just _mocked_ defines
        var localRequire = require.newContext();
